...
import { Home, CalendarPlus, ListOrdered, History, UserCircle } from "lucide-react";
...
export default function FarmerNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur border-t border-line grid grid-cols-5 md:hidden"
